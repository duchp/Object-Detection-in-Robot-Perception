...
def test_net(save_folder, net, cuda, testset, transform, thresh):
    ...
    filename = save_folder+'test_shoulder_min.csv'
    scorename = save_folder+'test_score_min.csv'
...
def test_voc():
    ...
    # load data
    testset = VOCDetection_shoulder(args.voc_root, [('hand', 'test_min')], None, VOCAnnotationTransform_shoulder())
    if args.cuda:
        net = net.cuda()
